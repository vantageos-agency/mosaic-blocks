...
`@vantageos/mosaic-blocks` is the **React composed-block layer** of the VantageOS Mosaic design system. It provides 132 opinionated, fully-typed UI components that integrate natively with:
...
|---|---|---|
| `0.5.12-alpha` | Current | 132 exported `Mosaic*` components — adds `MosaicApiKeyPanel` (presentational BYOK panel: idle/validating/valid/invalid, no storage, no network) |

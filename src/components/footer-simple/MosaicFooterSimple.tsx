 ...
 * />
 */
export const MosaicFooterSimple = React.forwardRef<HTMLElement, MosaicFooterSimpleProps>(
  function MosaicFooterSimple({ columns, legal, logo, social, className }, ref) {
    return (
      <footer
        ref={ref}
        className={cn(

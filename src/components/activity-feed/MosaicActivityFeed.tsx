...
const STATUS_CLASSES: Record<string, string> = {
  ...
  // allow-undeclared-theme-token: success-500/success-700 wired to canonical --mosaic-color-success-* (status triads are NOT aliased, #64); resolves via @import "@vantageos/mosaic-tokens/css" at styles.css:4; hand-declaring `var(--success-500)` here would duplicate tokens.css (derive-never-type).

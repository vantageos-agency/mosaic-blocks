...
**185** `Mosaic*` components and **291** total named exports; see `README.md`
...
**85 `Mosaic*` components** and **10 hooks** <!-- count-exempt: curated-subset figures, NOT derived from src/index.ts; the 180/283 library totals on this same line ARE derived and guarded --> out of the **185** `Mosaic*`
components (**291** total named exports) that `src/index.ts` actually
